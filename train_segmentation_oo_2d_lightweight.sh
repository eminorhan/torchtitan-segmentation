...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_segmentation_oo_2d_lightweight
#SBATCH --output=train_segmentation_oo_2d_lightweight_%A_%a.out
#SBATCH --array=4-7
...
CONFIG_FILES=(./configs/oo_2d_lightweight/*.toml)
