...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_segmentation_segmentation_head
#SBATCH --output=train_segmentation_segmentation_head_%A_%a.out
#SBATCH --array=0-7
...
CONFIG_FILES=(./configs/segmentation_head/*.toml)
