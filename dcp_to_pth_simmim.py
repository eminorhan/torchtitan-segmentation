...
if __name__ == "__main__":
    ...
    parser.add_argument("--dcp_dir", type=str, default="/lustre/blizzard/stf218/scratch/emin/torchtitan-mae/outputs/oo_3d_l_scratch_3em4_1/checkpoint/step-12000", help="Path to the distributed checkpoint folder")
    parser.add_argument("--output", type=str, default="oo_3d_l_scratch_3em4_1-8aa4cbdd.pth", help="Output .pth file path")
